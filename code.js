 if (usuario.rol === 'Jefatura' || usuario.rol === 'Colaborador') {
  ...
  if (usuario.rol === 'Jefatura' || usuario.rol === 'Colaborador') {
   const ini = cambios.fechaInicio ? new Date(cambios.fechaInicio) : fechaInicio ? new Date(fechaInicio) : null;
   const fin = cambios.fechaFin    ? new Date(cambios.fechaFin)    : fechaFin    ? new Date(fechaFin)    : null;
